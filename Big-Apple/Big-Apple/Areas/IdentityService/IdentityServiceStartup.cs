...
using Big_Apple.Identity.Data;
using Big_Apple.Identity.Models;
using Big_Apple.Identity.Services;

// HostingStartup's in the primary assembly are run automatically.
[assembly: HostingStartup(typeof(Big_Apple.Identity.IdentityServiceStartup))]

namespace Big_Apple.Identity
{
